...
/**
 * helper function to make checking collisions easier
 * @param {*} source 
 * @param {*} target 
 * @returns 
 */
export const didCollide = (source,target) =>{
 ...
 * @see https://gamedev.stackexchange.com/questions/13774/how-do-i-detect-the-direction-of-2d-rectangular-object-collisions
 *
 * @returns The direction that the first rectangle collided with the second. -1: Left; 1: Right;
 */
export const getHorizontalCollisionDirection = (
	x1,
	y1,
	width1,
	height1,
...
/**
 * helper function to fetch the collision direction
 * @param {*} source 
 * @param {*} target 
 * @returns 
 */
export const getKnockbackDirection = (source, target) => {
	return getHorizontalCollisionDirection(
		source.position.x,
		source.position.y,
		source.dimensions.x,
		source.dimensions.y,
